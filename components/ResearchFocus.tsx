    ...
    <section id="research" className="section-spacing bg-base-alt">
      <div className="section-container">
        <Reveal>
          ...
          <p className="mt-4 max-w-4xl text-base text-base-muted text-justify">{researchIntro}</p>
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            {researchAreas.map((area) => (
              ...
              >
                ...
                <p className="mt-3 text-base text-base-muted text-justify">{area.description}</p>
              </article>
            ))}
          </div>
        </Reveal>
